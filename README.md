...
<p>Create database tables and seed data inside it by <code>php artisan migrate:fresh --seed</code> command.<br>(You can skip this if you want to use the database and image files provided in the <code>extras</code> folder.)</p>
