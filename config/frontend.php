...
return [
    'routes' => [
        ...
        'search'             => [
            ...
            'controller' => $home_controller,
            'function'   => 'search',
            'middleware' => ['maintenance', 'remove_token']
        ],
        'autocompleteSearch' => [
            'method'     => 'get',
            'uri'        => 'oto-arama',
        ...
        'redirect-linkedin' => [
            'method'     => 'get',
            'uri'        => 'redirect-linkedin',
            'controller' => $linkedin_service,
            'function'   => 'redirectToLinkedin',
            'middleware' => ['maintenance', 'prevent_if_login']
        ],
        'handle-linkedin'   => [
            'method'     => 'get',
            'uri'        => 'callback-linkedin',
            'controller' => $linkedin_service,
        ...
        'update-profile'            => [
            ...
            'middleware' => ['maintenance', 'is_login_user', 'is_verify_email']
        ],
        'user-logout'               => [
            'method'     => 'get',
            'uri'        => 'cikis',
        ...
        'user-verify'               => [
            'method'     => 'get',
            'uri'        => 'profil/dogrula/{user_id}/{token}',
            'controller' => $user_controller,
            'function'   => 'verifyAccount',
            'middleware' => ['maintenance', 'is_banned_not_login', 'prevent_if_login']
        ],
        'user-make-game-comment'    => [
            'method'     => 'post',
            'uri'        => 'yorum-yap/{commentable_id}',
            'controller' => $user_controller,
            'function'   => 'makeGameComment',
            'middleware' => ['maintenance', 'is_login_user', 'is_banned']
        ],
        'user-edit-game-comment'    => [
            'method'     => 'post',
            'uri'        => 'yorum-duzenle/{commentable_id}/{comment_id}',
            'controller' => $user_controller,
            'function'   => 'editGameComment',
            'middleware' => ['maintenance', 'is_login_user', 'is_banned']
        ],
        'user-reply-game-comment'   => [
            'method'     => 'post',
            'uri'        => 'yorum-yanitla/{commentable_id}/{parent_comment_id}/{sub_comment_id?}',
            'controller' => $user_controller,
            'function'   => 'replyGameComment',
            'middleware' => ['maintenance', 'is_login_user', 'is_banned']
        ],
        'user-delete-game-comment'  => [
            'method'     => 'post',
            'uri'        => 'yorum-sil',
            'controller' => $user_controller,
