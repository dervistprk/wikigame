...
return [
    ...
    'routes' => [
        ...
        'user-make-game-comment'    => ['method' => 'post', 'uri' => 'yorum-yap/{commentable_id}', 'controller' => $user_controller, 'function' => 'makeGameComment', 'middleware' => ['maintenance', 'is_login_user', 'is_banned']],
        'user-edit-game-comment'    => ['method' => 'post', 'uri' => 'yorum-duzenle/{commentable_id}/{comment_id}', 'controller' => $user_controller, 'function' => 'editGameComment', 'middleware' => ['maintenance', 'is_login_user', 'is_banned']],
        'user-reply-game-comment'   => ['method' => 'post', 'uri' => 'yorum-yanitla/{commentable_id}/{parent_comment_id}/{sub_comment_id?}', 'controller' => $user_controller, 'function' => 'replyGameComment', 'middleware' => ['maintenance', 'is_login_user', 'is_banned']],
        'user-delete-game-comment'  => ['method' => 'post', 'uri' => 'yorum-sil', 'controller' => $user_controller, 'function' => 'deleteComment', 'middleware' => ['maintenance', 'is_login_user', 'is_banned']],
        'user-like-game-comment'    => ['method' => 'post', 'uri' => 'yorum-begen', 'controller' => $user_controller, 'function' => 'likeComment', 'middleware' => ['maintenance', 'is_login_user', 'is_banned']],
        'user-dislike-game-comment' => ['method' => 'post', 'uri' => 'yorum-begenme', 'controller' => $user_controller, 'function' => 'dislikeComment', 'middleware' => ['maintenance', 'is_login_user', 'is_banned']],
    ]
];