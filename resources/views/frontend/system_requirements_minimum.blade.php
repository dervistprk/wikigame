        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>{{ $game->systemReqMin->ram_min }} @if($game->systemReqMin->ram_min_unit == 0) MB @else GB @endif</td>
                </tr>
                <tr>
                    <th><img src="{{asset('assets/sys_req_icons/storage.png')}}" alt="storage_min" width="25" height="25"> Depolama Alanı</th>
                    <td>{{ $game->systemReqMin->storage_min }} @if($game->systemReqMin->storage_min_unit == 0) MB @else GB @endif</td>
                </tr>
                <tr>
