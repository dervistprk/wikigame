<div class="card sys-req-rec-card">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>{{ $game->systemReqRec->ram_rec }} @if($game->systemReqRec->ram_rec_unit == 0) MB @else GB @endif</td>
                </tr>
                <tr>
                    <th><img src="{{asset('assets/sys_req_icons/storage.png')}}" alt="storage_min" width="25" height="25"> Depolama Alanı</th>
                    <td>{{ $game->systemReqRec->storage_rec }} @if($game->systemReqRec->storage_rec_unit == 0) MB @else GB @endif</td>
                </tr>
                <tr>
