<footer class="footer text-center text-white">
        ...
        @foreach($socials as $social)
            @if($settings->$social != null)
                <div class="text-center d-inline-block">
                    <a href="{{$settings->$social}}" title="{{ucfirst($social)}} Adresimiz" target="_blank" class="text-decoration-none">
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        ...
        <span class="text-center d-block">© {{\Illuminate\Support\Carbon::now()->format('Y')}} WikiGame</span>
    </div>
</footer>
