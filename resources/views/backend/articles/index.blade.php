                ...
                <table id="datatablesSimple" class="table-responsive">
                    ...
                    @foreach($articles as $article)
                        ...
                        <tr class="@if($article->status == 0) alert-danger @endif">
                            <td><img src="{{ $article->image }}" alt="{{ $article->title }}" title="{{ $article->title }}" class="img-fluid rounded img-thumbnail" width="320" height="180"></td>
                            ...
                            <td>
                                ...
                                <div class="mt-1">
                                    <a href="#" data-id="{{$article->id}}" class="btn btn-danger delete" data-toggle="modal" data-target="#delete{{$target->slug}}Modal_{{$target->id}}"><i class="fas fa-trash"></i> Sil</a>
                                </div>
                            </td>
                        </tr>
