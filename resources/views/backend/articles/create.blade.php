...
@section('content')
    <div class="container">
        <form class="mt-2 needs-validation" novalidate method="post" action="{{route('admin.create-article-post')}}"
                    ...
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title"
                                   placeholder="Makale Başlığını Giriniz" value="{{ old('title') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sub_title" name="sub_title"
                                   placeholder="Makale Alt Başlığını Giriniz" value="{{ old('sub_title') }}" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="writing" name="writing" rows="5"
                                      placeholder="Makale İçeriğini Giriniz" required>{{ old('writing') }}</textarea>
                            <div class="invalid-feedback">
