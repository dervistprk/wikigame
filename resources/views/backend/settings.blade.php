            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="footer_text" class="font-weight-bold form-label text-primary">Site Footer Yazısı</label>
                    ...
                    <div class="form-group">
                        <label for="about_text" class="font-weight-bold form-label text-primary">Site Hakkında Yazısı*</label>
                    ...
                    <div class="form-group">
                        <label for="meta_description" class="font-weight-bold form-label text-primary">Meta Açıklaması*</label>
                    ...
                    <div class="form-row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="site_status" class="font-weight-bold col-form-label text-primary">Site Durumu*</label>
