...
@section('title', 'Tür Ekle')
@section('content')
    <div class="container">
        <form class="mt-2 needs-validation" novalidate method="post" action="{{route('admin.create-genre-post')}}">
            @if($errors->any())
            ...
            <div class="card shadow">
                <div class="card-header font-weight-bold text-secondary">
                    ...
                    Tür Ekle <span class="float-end text-secondary">* Zorunlu Alanlar</span>
                </div>
                <div class="card-body">
                    <div class="col-sm-6">
            ...
            <div class="form-group mt-3 text-center">
                ...
                <a href="{{route('admin.genres')}}" class="btn btn-danger"><i class="fa fa-backspace"></i> Vazgeç</a>
            </div>
        </form>
    </div>
@endsection