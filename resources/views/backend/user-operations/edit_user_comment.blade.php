...
@section('content')
    <div class="container">
        <form class="mt-2 needs-validation" method="post" novalidate
              action="{{ route('admin.edit-user-comment', $comment->id) }}">
            @if($errors->any())
                ...
                <div class="card-body">
                    <div class="col-sm">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                           placeholder="Yorum Yapan Kişi Adı" value="{{ $comment->user->name }}"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="surname" name="surname"
                                           placeholder="Yorum Yapan Kişi Soyadı" value="{{ $comment->user->surname }}"
                                           readonly style="cursor: not-allowed">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                           placeholder="Yorum Yapan Kişi E-Posta" value="{{ $comment->user->email }}"
                                           readonly style="cursor: not-allowed">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="body" name="body" placeholder="Yorumu Düzenleyin"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="is_verified" name="is_verified">
                                        <option @if($comment->is_verified == 0) selected="selected"
                                                @endif value="0">Pasif
                                        </option>
                                        <option @if($comment->is_verified == 1) selected="selected" @endif value="1"
                                                @if($comment->user->is_banned == 1) disabled @endif>Aktif
                                        </option>
                                    </select>
            ...
            <div class="form-group mt-3 text-center">
                ...
                <a href="{{route('admin.user-comments', $comment->user->id)}}" class="btn btn-danger"><i
