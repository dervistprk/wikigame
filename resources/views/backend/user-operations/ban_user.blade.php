    ...
    <div class="container">
        <form class="mt-2 needs-validation" method="post" novalidate action="{{ route('admin.ban-user', $user->id) }}">
                    ...
                    <div class="col-sm">
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                           placeholder="E-Posta" value="{{ $user->email }}" readonly
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label for="user_name"
                                           class="text-primary form-label font-weight-bold">Kullanıcı Adı</label>
                                    <input type="text" class="form-control" id="user_name" name="user_name"
                                           placeholder="Kullanıcı Adı" value="{{ $user->user_name }}" readonly
                                           style="cursor: not-allowed">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Ad"
                                           value="{{ $user->name }}" readonly style="cursor: not-allowed">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="surname" name="surname"
                                           placeholder="Soyad" value="{{ $user->surname }}" readonly
                                           style="cursor: not-allowed">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="ban_reason"
                                   class="text-primary form-label font-weight-bold">Yasak Sebebi*</label>
                            <textarea class="form-control" id="ban_reason" name="ban_reason"
                                      placeholder="Yasak sebebini yazın" required></textarea>
            ...
            <div class="form-group mt-3 text-center">
                ...
                <a href="{{route('admin.user-operations')}}" class="btn btn-danger"><i
