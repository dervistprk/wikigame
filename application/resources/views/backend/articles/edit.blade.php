...
@section('content')
    <div class="container">
        <form class="mt-2 needs-validation" novalidate method="post"
              action="{{route('admin.edit-article-post', [$article->id])}}" enctype="multipart/form-data">
            @if($errors->any())
                    ...
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title"
                                   placeholder="Makale Başlığını Giriniz" value="{{ $article->title }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sub_title" name="sub_title"
                                   placeholder="Makale Alt Başlığını Giriniz" value="{{ $article->sub_title }}"
                                   required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <label for="writing"
                                   class="text-primary form-label font-weight-bold">Makale İçeriği*</label>
                            <textarea class="form-control" id="writing" name="writing" rows="5"
                                      placeholder="Makale İçeriğini Giriniz" required>{{ $article->writing }}</textarea>
                            <div class="invalid-feedback">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option @if($article->status == 0) selected="selected" @endif value="0">Pasif
                                        </option>
                                        <option @if($article->status == 1) selected="selected" @endif value="1">Aktif
                                        </option>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <img src="{{ $article->image }}" alt="{{ $article->title }}"
                                         title="{{ $article->title }}" class="mt-1 rounded img-fluid img-thumbnail"
